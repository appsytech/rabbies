            ...
            <form id="dataForm" action="{{ route('publication.update') }}" method="POST"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="relative">
                            <div id="descriptionEditor" style="height: 300px;">{!! $data['publication']->description ?? '' !!}</div>
                            <input type="hidden" name="description" value="{{ $data['publication']->description ?? '' }}" id="description">
                        </div>
                    </div>
