...
<div class="p-4 bg-gray-50">
    <nav class="text-sm text-gray-500">
        <ol class="list-reset flex">
            ...
            <li>
                <a href="{{ route('service.index') }}" class="text-blue-600 hover:text-blue-700 font-medium">Service</a>
            </li>
            <li><span class="mx-2">/</span></li>
            <li class="text-gray-700">Edit Service</li>
        </ol>
    </nav>
</div>
...
<div>
    <div class="w-full lg:w-1/2 flex flex-col max-h-[90%] mx-auto bg-white rounded-3xl shadow-lg overflow-hidden">
        ...
        <div class="px-8 py-6 overflow-y-auto h-[90%]">
            <form id="dataForm" action="{{ route('service.update') }}" method="POST" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" placeholder="Enter Title..." value="{{ $data['service']->title ?? '' }}" name="title" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" value="{{ $data['service']->location ?? '' }}" placeholder="Enter Location..." name="location"
                                class="w-full px-4 py-2.5 text-sm text-gray-700 bg-white border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm hover:shadow-md placeholder-gray-400">
                        </div>
                    </div>
                    ...
                    <div id="iconPreviewContainer" class="{{ isset($data['service']->icon) ? '' : 'hidden' }} lg:col-span-2">
                    ...
                    <div id="image1PreviewContainer" class="{{ isset($data['service']->images1) ? '' : 'hidden' }} lg:col-span-2">
                    ...
                    <div id="image2PreviewContainer" class="{{ isset($data['service']->images2) ? '' : 'hidden' }} lg:col-span-2">
                    ...
                    <!--=== Image 3 Preview Section ====-->
                    <div id="image3PreviewContainer" class="{{ isset($data['service']->images3) ? '' : 'hidden' }} lg:col-span-2">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="status" required
                                ...
                                <option value="1" {{ $data['service']->status == '1' ? 'selected' : '' }}>Active
                                </option>
                                <option value="0" {{ $data['service']->status == '0' ? 'selected' : '' }}>Inactive
                                </option>
                            </select>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" placeholder="Enter Sort..." name="sort" value="{{ $data['service']->sort ?? 0 }}" required
                                class="w-full px-4 py-2.5 text-sm text-gray-700 bg-white border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm hover:shadow-md placeholder-gray-400">
                        </div>
                    </div>
