            ...
            <form id="dataForm" action="{{ route('about-feature.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="relative">
                            <div id="descriptionEditor" style="height: 300px;">{!! $data['feature']->description ?? '' !!}</div>
                            <input type="hidden" value="{{ $data['feature']->description ?? '' }}" name="description" id="description">
                        </div>
                    </div>
