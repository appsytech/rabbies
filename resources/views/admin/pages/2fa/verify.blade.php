        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Open your authenticator app and enter the 6-digit code shown for this account.
                    </p>
                </div>

                <form action="{{ route('google.2fa.verify.proceed') }}" method="POST" class="space-y-5">
                    @csrf
                    {{-- ==== Otp ==== --}}
                    {{-- <x-admin.globals.forms.form-field-secondary type="number" name="otp" label="OTP" required
                        :leftIcon="asset('assets/svg/shield.svg')" placeholder="......" /> --}}
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <img src="{{ asset('assets/svg/shield.svg') }}" class="w-5 h-5">
                            </div>
