...
<div class="min-h-screen flex items-start justify-center ">
    ...
    <div class="w-full max-w-3xl">
        ...
        <!--===== Setup Instructions  ====-->
        @if(!$data['user']->google2fa_enabled)
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-5">
            <h2 class="text-sm font-semibold text-gray-900 mb-4">How to set up</h2>
            <div class="grid grid-cols-3 gap-4">
                <div class="flex gap-3 items-start">
                    <div class="w-7 h-7 rounded-full bg-blue-600 shrink-0 flex items-center justify-center mt-0.5">
                        <span class="text-white text-xs font-bold">1</span>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-gray-800">Install the app</p>
                        <p class="text-xs text-gray-500 mt-0.5">Download
                ...
                <div class="flex gap-3 items-start">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-800">Scan QR code</p>
                        <p class="text-xs text-gray-500 mt-0.5">Open the app, tap <span class="font-medium text-gray-700">"Add account"</span>, then scan the QR code below.</p>
                    </div>
                </div>
                <div class="flex gap-3 items-start">
                    <div class="w-7 h-7 rounded-full bg-blue-600 shrink-0 flex items-center justify-center mt-0.5">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-800">Enter the code</p>
                        <p class="text-xs text-gray-500 mt-0.5">Enter the 6-digit code shown in your authenticator app to confirm setup.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div class="grid grid-cols-1 divide-x divide-gray-100">
                ...
                <div class="p-8 flex flex-col justify-center">
                    ...
                    <form action="{{ route('google.2fa.enable', ['id' => $data['id'], 'role' => $data['role'] ?? '']) }}" method="POST">
