...
<div class="p-4 bg-gray-50">
    <nav class="text-sm text-gray-500">
        <ol class="list-reset flex">
            ...
            <li>
                <a href="{{ route('navigation-menu.index') }}" class="text-blue-600 hover:text-blue-700 font-medium">Navigation Menu</a>
            </li>
            <li><span class="mx-2">/</span></li>
...
<div>
    <div class="w-full lg:w-1/2 flex flex-col max-h-[90%] mx-auto bg-white rounded-3xl shadow-lg overflow-hidden">
        ...
        <div class="px-8 py-6 overflow-y-auto h-[90%]">
            <form id="dataForm" action="{{ route('navigation-menu.update') }}" method="POST"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="status" required
                                ...
                                <option value="1"
                                    {{ ($data['navigation']->status ?? null) == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0"
                                    {{ ($data['navigation']->status ?? null) == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
                ...
                <div class="hidden">
                    <input type="hidden" name="id" value="{{ $data['navigation']->id }}">
                </div>

                <!--=== Action Buttons ===-->
                <div class="flex gap-3 pt-2">
                    <a href="{{ route('navigation-menu.index') }}"
