                                    ...
                                    <td class="p-4 text-sm text-gray-600">
                                        @if (!$admin->google2fa_enabled)
                                            <a href="{{ route('google.2fa.setup', ['id' => encrypt($admin->id)]) }}"
                                                ...
                                                title="Enable 2FA">
                                                <img src="{{ asset('assets/svg/shield.svg') }}"
                                                    class="w-4 h-4 pointer-events-none" alt="2FA">
                                                <span class="text-xs font-medium pointer-events-none">Enable 2FA</span>
                                            </a>
                                        @else
                                            @if ($admin->admin_role == 1)
                                                <button type="button"
                                                    class="inline-flex items-center gap-1 px-3 py-1 rounded-md border border-gray-300 cursor-pointer text-gray-500 hover:text-green-600 hover:border-green-300 hover:bg-green-50 transition"
                                                    title="Enabled">
                                                    <img src="{{ asset('assets/svg/shield.svg') }}"
                                                        class="w-4 h-4 pointer-events-none" alt="2FA">
                                            ...
                                            @else
                                                <a href="{{ route('google.2fa.disable.setup', ['id' => encrypt($admin->id)]) }}"
                                                    class="confirm-link inline-flex items-center gap-1 px-3 py-1 rounded-md border border-gray-300 cursor-pointer text-gray-500 hover:text-green-600 hover:border-green-300 hover:bg-green-50 transition"
                                                    title="Disable 2FA">
                                                    <img src="{{ asset('assets/svg/shield.svg') }}"
                                                        class="w-4 h-4 pointer-events-none" alt="2FA">
                                                    <span class="text-xs font-medium pointer-events-none">Disabled
                                                        2FA</span>
                                                </a>
                                            @endif
                                        @endif
