                ...
                <form id="dataForm" action="{{ route('social-media-config.update') }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="relative">
                                <input type="file" id="imageUpload" name="icon"
                        ...
                        <div id="iconPreviewContainer"
                            class="{{ isset($data['config']->icon) ? '' : 'hidden' }} lg:col-span-2">
                            @if (isset($data['config']->icon))
                                <div class="relative inline-flex gap-2">
                                    <img src="{{ asset('storage/' . $data['config']->icon) }}"
