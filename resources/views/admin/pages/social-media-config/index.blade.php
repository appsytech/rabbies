    ...
    <div class="p-4 bg-gray-50 ">
        <nav class="text-sm text-gray-500">
            <ol class="list-reset flex">
                ...
                <li class="text-gray-700">Social Media Config</li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <main class="flex-1 overflow-y-auto bg-gray-50 p-2">
        ...
        <div class="rounded-sm shadow-md border border-gray-200">
            <div class="border-b border-gray-200">
                <!--=========== Filter Form ============-->
                <form action="{{ route('social-media-config.index') }}" method="GET" class="p-2 border-b border-gray-200">
                    <div
                        ...
                        <div
                            ...
                            <div>
                                <label class="text-xs font-semibold text-gray-700 mb-2 flex items-center gap-1.5">
                                    <img src="{{ asset('assets/svg/share-two.svg') }}"
                        ...
                        <div class="col-span-4 xl:col-span-1  flex items-end justify-end">
                            <div class="flex gap-2">
                                ...
                                <button type="button" data-targetModalId="social-media-add-modal"
                                ...
                                <tr class="border-b border-gray-200">
                                    ...
                                    <td class="p-4">
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input data-targetUrl="{{ route('social-media-config.status.update') }}"
                                    ...
                                    <td class="p-4">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('social-media-config.edit', $config->id) }}">
                                                <img src="{{ asset('assets/svg/pencil.svg') }}"
                                                    class="w-4 h-4 cursor-pointer">
                                            </a>

                                            <form action="{{ route('social-media-config.delete') }}" method="POST">
                                                @csrf
                                                @method('delete')
            ...
            <div class="w-full lg:w-[30%] flex flex-col max-h-[90%] mx-auto bg-white rounded-3xl shadow-lg overflow-hidden">
                ...
                <div class="p-5 border-b border-gray-100 h-[10%]">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900">Add new Social Media</h2>
                ...
                <div class="px-8 py-6 overflow-y-auto h-[90%]">
                    <form action="{{ route('social-media-config.store') }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" placeholder="Enter Social Media Url..." name="link" required
                                        class="w-full px-4 py-2.5 text-sm text-gray-700 bg-white border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm hover:shadow-md placeholder-gray-400">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" placeholder="Enter Sort Order.." name="sort" required
                                        class="w-full px-4 py-2.5 text-sm text-gray-700 bg-white border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm hover:shadow-md placeholder-gray-400">
                                </div>
                            </div>
