                ...
                <form id="dataForm" action="{{ route('activity.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="author" value="{{ $data['activity']->author }}"
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="relative">
                                <textarea type="text" name="description" required placeholder="Enter description..."
                                    class="w-full px-4 py-2.5 text-sm text-gray-700 bg-white border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm hover:shadow-md placeholder-gray-400">{{ $data['activity']->description }}</textarea>
                            </div>
                        </div>
