                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                <div class="donation-card-item-2 mt-0">
                                    ...
                                    <div class="donation-image">
                                        ...
                                        <div class="news-layer-wrapper">
                                            <div class="news-layer-image"
                                                style="background-image: url('{{ asset('storage/' . $activity->images) }}');">
                                            </div>
                                            <div class="news-layer-image"
                                                style="background-image: url('{{ asset('storage/' . $activity->images) }}');">
                                            </div>
                                    ...
                                    <div class="donation-content">
                                        <h4>
                                            <a
                                                href="{{ route('web.activity.show', encrypt($activity->id)) }}">{{ $activity->title }}</a>
                                        </h4>
                                        <p>
                                    ...
                                    <div class="progress">
                                        ...
                                        <ul class="donate-list">
                                            ...
                                            <li>
                                                <span>Date -
                                                    {{ \Illuminate\Support\Carbon::parse($activity->created_at)->format('Y-m-d') }}</span>
                                            </li>
                                        </ul>
                                        <a href="{{ route('web.activity.show', encrypt($activity->id)) }}"
                                            class="theme-btn style-2">See More <i
