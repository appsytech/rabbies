        ...
        <div class="container">
            <div class="page-heading">
                <div class="breadcrumb-sub-title">
                    <h1 class="wow fadeInUp" data-wow-delay=".3s">Publication Details</h1>
                </div>
                            ...
                            <div class="news-details-content">
                                <ul class="date-list">
                                    <li>
                                        ...
                                        {{ \Illuminate\Support\Carbon::parse($publication->created_at)->format('Y-m-d') }}
                                    </li>
                                    <!-- <li>
                                    ...
                                    @isset($publication->document)
                                        <div class="mt-3">
                                            <a href="{{ asset('storage/' . $publication->document) }}" download
                                                class="download-btn">
                        ...
                        <div class="main-sideber">
                            ...
                            <div class="single-sidebar-widget">
                                ...
                                <div class="recent-post-area">
                                    @if ($data['relatedPublications']->isNotEmpty())
                                        @foreach ($data['relatedPublications'] as $publication)
                                            <div class="recent-items">
                                                ...
                                                <div class="recent-content">
                                                    <h6>
                                                        <a
                                                            href="{{ route('web.publication.show', encrypt($publication->id)) }}">
                                                            {{ $publication->title ?? '' }}
                                                        </a>
                                                    </h6>
                                                    <ul>
