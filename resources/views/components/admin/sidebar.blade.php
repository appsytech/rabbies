    ...
    <nav class="p-4 space-y-1 flex-1 overflow-y-auto">
        ...
        <div>
            ...
            <div id="setting-submenu"
                ...
                <a href="{{ route('navigation-menu.index') }}" data-nav
                    class="block px-4 py-2 text-sm  rounded-lg hover:bg-[#EEF2FF] {{ Route::currentRouteName() == 'navigation-menu.index' || Route::currentRouteName() == 'navigation-menu.edit' ? 'bg-blue-100 text-black is_active' : 'text-gray-700' }} hover:text-gray-900 transition-colors">
                    Navigation
                </a>
            </div>
        </div>
